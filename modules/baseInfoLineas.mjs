const lineaBaseInfo_OBJ = {
  cs_almazora: {
    ...
    maquina: {
      ...
      keyChangeBillete: "^",
      observaciones:
        "En el 'Barranquet' pulsar <strong>^</strong> para cambiar tipo de billete",
    },
    rutas: {
      laborables: {
        value: "Laborables",
          ...
          bus_1: {
            ...
            turno: {
              manana: {
                ...
                lgFin: "C/ Fernando Católico 1<br>'Grapa'",
                hrInicio: "07:00",
                hrFin: "13:45",
              ...
              mediodia: {
                value: "Mediodia",
                lgInicio: "C/ Fernando Católico 1<br>'Grapa'",
                lgFin: "Pl. Juez Borrull<br>[Castellón]",
                hrInicio: "13:45",
                hrFin: "22:00",
                horarios: ['14:00', '14:30', '15:00', '15:30', '16:00', '16:30', '17:00', '17:30', '18:00', '18:30', '19:00', '19:30', '20:00', '20:30', '21:00', '21:30'],
                parteTrabajo: {
                  hrInicio: "14:00",
                  hrFin: "22:00",
                  hrNoctur: "",
